...
public class PersonalInstrument {
    ...
    public void setPersonalInstrumentPrice(String personalInstrumentPrice) {
        if (personalInstrumentPrice.isEmpty()) {
            this.personalInstrumentPrice = null;
        } else {
            this.personalInstrumentPrice = personalInstrumentPrice;
        }
    }
