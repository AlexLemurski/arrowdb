...
public class MeasInstrument {
    ...
    public void setMeasInstrumentPrice(String measInstrumentPrice) {
        if (measInstrumentPrice.isEmpty()) {
            this.measInstrumentPrice = null;
        } else {
            this.measInstrumentPrice = measInstrumentPrice;
        }
    }
