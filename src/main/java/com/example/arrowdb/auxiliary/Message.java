...
public class Message {
    ...
    public static String CHANGE_STATUS_EMPLOYEE_MESSAGE = "Не возможно удалить Работника или присвоить " +
            "статус 'Закрыт', если за ним числится корпоративное имущество, или Работник закреплен за " +
            "Объектом строительства";

    public static String CHANGE_STATUS_PROFESSION_MESSAGE = "Не возможно присвоить статус 'Закрыт' Должности, " +
            "если она присвоена хотя бы одному из Работников";

    public static String DELETE_PROFESSION_MESSAGE = "Не возможно удалить Должность если она присвоена " +
            "хотя бы одному из Работников, в т.ч. со статусом 'Закрыт'";

    public static String DELETE_DEPARTMENT_MESSAGE = "Не возможно удалить Структурное подразделение если за ним " +
            "числятся работники, в т.ч. со статусом 'Закрыт', инструмент и техника";

    public static String CHANGE_STATUS_DEPARTMENT_MESSAGE = "Не возможно присвоить статус 'Закрыт' Структурному " +
            "подразделению, если в нем числятся Работники";

    public static String UNIQUE_PERSPECTIVE = "Данный ЛОТ или наименование объекта уже существуют";

    public static String UNIQUE_PROFESSION = "Данная должность уже существует";

    public static String UNIQUE_DEPARTMENT = "Данное структурное подразделение уже существует";
