...
public class EventsController {
    ...
    private final ProfessionAUDRepository professionAUDRepository;
    private final DepartmentService departmentService;
    private final DepartmentAUDRepository departmentAUDRepository;
    ...
    @GetMapping("/general/profession/professionJournal/{id}")
    public String getProfessionJournal(@PathVariable("id") int id, Model model) {
        model.addAttribute("profession", professionService
                .findProfessionById(id));
        model.addAttribute("professionAUDList", professionAUDRepository
                .findAllProfessionAUDById(id));
        return "profession/profession_event-journal";
    }

    @GetMapping("/general/department/departmentJournal/{id}")
    public String getDepartmentJournal(@PathVariable("id") int id, Model model) {
        model.addAttribute("department", departmentService
                .findDepartmentById(id));
        model.addAttribute("departmentAUDList", departmentAUDRepository
                .findAllDepartmentAUDById(id));
        return "department/department_event-journal";
    }
